...
class CapstoneTestCase(unittest.TestCase):
    ...
    def test_400_no_inputs_for_add_actor(self):
        res = self.client().post(
            '/actors', headers={"Authorization": "Bearer {}".format(self.casting_director)})
    ...
    def test_delete_actor(self):
        ...
        res = self.client().delete(
            f'/actors/{actor_id}', headers={"Authorization": "Bearer {}".format(self.casting_director)})
        data = json.loads(res.data)
    ...
    def test_404_update_actor_failure(self):
    ...
    def test_400_no_inputs_for_add_movie(self):
        res = self.client().post(
            '/movies', headers={"Authorization": "Bearer {}".format(self.executive_producer)})
    ...
    def test_delete_movie(self):
        ...
        res = self.client().delete(
            f'/movies/{movie_id}', headers={"Authorization": "Bearer {}".format(self.executive_producer)})
        data = json.loads(res.data)
    ...
    # no movie found with the given id
    def test_404_update_movie_failure(self):
